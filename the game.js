...
if (sprookje =='elfen')
{var elfen=prompt (
'je bent nu met de elfen en laten je kiezen tussen vliegen of lopen')
}
...
if (lopen=='ja')
alert('je volgt hem en raakt hem kwijt nu kom je helemaal nier meer thuis en je ziet rare wezens en ZE ETEN JE OP!!!!')
